...
def global_alignment(seq1, seq2, n, m, gap_opening, gap_extension):
...
if __name__ == '__main__':
    with open('rosalind_ba5e.txt', 'r') as file:
        ...
        print(global_alignment(seq1, seq2, n, m)[0])
        print(global_alignment(seq1, seq2, n, m)[1])
        print(global_alignment(seq1, seq2, n, m)[2])